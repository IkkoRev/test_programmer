...
Backend service untuk ingesting, normalisasi, pencarian, dan analisis media mentions. Dibangun dengan Node.js, TypeScript, Express, dan SQLite.
...
- **Sesi 1 (~2-3 jam):** Analisis brief dan seed_mentions.json, desain schema database, implementasi endpoint bulk ingest beserta logika deduplikasi 3-layer.
- **Sesi 2 (~2 jam):** Implementasi endpoint search dan stats, penulisan tes untuk logika deduplikasi & normalisasi, penulisan dan review README.
